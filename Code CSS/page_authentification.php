...
<div id="sub_title">
    ...
    <a class="Partenaire" href="Partenaires.php">PARTENAIRES</a>
        ...
        <div class="Formulaire_Connexion" style="display: block;" id="Formulaire_Connexion">  
...
<!------------------------------------------------------------- Partie Inscription ---------------------------------------------------------------------------------------------------------------------------->
        ...
        <div class="Formulaire_Inscription" id="formulaire_inscription" <?php if (!isset($_POST["confirmer_inscription"])) echo 'style="display: none;"'; ?>>
